...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-burgundy-950 text-ivory-100 font-sans pb-24 md:pb-14 pt-16 sm:pt-20 border-t-2 border-brass-500/40 relative overflow-hidden transition-colors shadow-2xl">
      ...
      <div className="absolute -bottom-14 -left-10 text-[200px] sm:text-[280px] font-serif text-white/[0.03] font-bold select-none pointer-events-none leading-none">
        AP
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Top Editorial Section: Large Name, Hindi Maxim & Coordinates */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 pb-12 sm:pb-16 border-b border-burgundy-800/80">
          ...
          <div className="lg:col-span-6 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <div className="h-[1.5px] w-8 bg-brass-400/60" />
            </div>

            <div>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif text-ivory-50 font-normal tracking-tight">
                {adv.name} <span className="text-brass-300 text-2xl sm:text-3xl font-serif">({adv.alias})</span>
              </h2>
              <p className="text-lg sm:text-xl font-serif text-ivory-300 italic mt-0.5">
                {adv.hindiName}
              </p>
              <p className="text-xs uppercase tracking-[0.18em] text-brass-400 mt-1.5 font-bold font-mono">
                Advocate · {adv.court}
              </p>
            </div>
            ...
            {/* Motto */}
            <div className="pt-2">
              <p className="font-serif text-2xl sm:text-3xl text-brass-300 tracking-wide font-normal">
                “{adv.motto}”
              </p>
              <p className="text-xs text-ivory-300 uppercase tracking-widest mt-0.5 font-mono">
          ...
          <div className="lg:col-span-3 space-y-3.5">
            <h3 className="text-xs uppercase tracking-[0.25em] text-brass-400 font-bold font-mono">
              Chambers Index
            </h3>
            <ul className="space-y-2.5 text-xs sm:text-sm text-ivory-200">
              <li>
            ...
            <div className="space-y-3 text-xs sm:text-sm text-ivory-200">
              ...
              <div className="pt-2">
                <a
                  ...
                  className="inline-flex items-center gap-1.5 text-xs text-emerald-400 hover:text-emerald-300 font-bold font-mono uppercase tracking-wider"
                >
        ...
        <div className="py-6 sm:py-8 border-b border-burgundy-800/80 text-[11px] leading-relaxed text-ivory-300/80 text-balance">
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-ivory-400 gap-3">
          <p>
            © {new Date().getFullYear()} Chambers of Ashutosh Pandey (Jayesh), Advocate High Court Allahabad.
          </p>

          <div className="flex items-center space-x-6">
            <Link to="/admin" className="hover:text-brass-300 transition-colors flex items-center gap-1.5 text-[11px] uppercase tracking-widest font-mono font-semibold">
