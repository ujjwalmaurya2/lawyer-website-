...
export const HomeContactSection: React.FC = () => {
  ...
  return (
    <section className="py-20 sm:py-28 bg-ivory-100 dark:bg-[#08090A] border-b border-ivory-300 dark:border-stone-800 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Dramatic Split Screen Container */}
        <div className="grid grid-cols-1 lg:grid-cols-12 rounded-2xl border-2 border-brass-500/40 overflow-hidden shadow-2xl">
          ...
          <div className="lg:col-span-5 bg-gradient-to-br from-burgundy-950 via-burgundy-900 to-burgundy-950 text-ivory-50 p-8 sm:p-12 flex flex-col justify-between space-y-8 relative overflow-hidden">
            
            {/* Background Decorative Lines */}
            <div className="absolute top-0 right-0 w-36 h-36 border-b border-l border-brass-400/20 pointer-events-none" />

            <div className="space-y-6 relative z-10">
              <div className="flex items-center justify-between">
                <span className="text-[10px] uppercase tracking-[0.25em] text-brass-400 font-bold px-3 py-1 bg-burgundy-950 border border-brass-500/40 rounded font-mono">
                  HIGH COURT CHAMBERS
                </span>
              ...
              <div>
                <span className="text-4xl sm:text-6xl font-serif text-ivory-50 font-normal tracking-tight block">
                  Chamber 62
                </span>
                <span className="text-xs uppercase tracking-widest text-brass-300 font-mono font-bold block mt-1.5">
            ...
            <div className="pt-4 border-t border-burgundy-800 relative z-10 space-y-1">
              <span className="text-[10px] uppercase font-mono text-brass-400 font-bold tracking-wider block">
                Direct Chamber Line:
              </span>
              <a href={`tel:${adv.phone}`} className="text-xl sm:text-2xl font-serif font-bold text-ivory-50 hover:text-brass-300 transition-colors font-mono">
                {adv.phone}
              </a>
            </div>
          </div>

          {/* Right Split: Warm Ivory Coordinates & Actions */}
          <div className="lg:col-span-7 bg-white dark:bg-charcoal-850 p-8 sm:p-12 flex flex-col justify-between space-y-8">
            ...
            <div className="space-y-6">
              <div className="space-y-1">
                ...
                <h3 className="text-2xl sm:text-3xl font-serif text-charcoal-800 dark:text-ivory-100 font-normal">
              ...
              <div className="space-y-4 text-xs sm:text-sm text-stone-700 dark:text-stone-300">
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    <span className="text-charcoal-800 dark:text-ivory-100 font-bold block text-sm">
                ...
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    <span className="text-stone-500 dark:text-stone-400 text-xs block">Official Email:</span>
                    <a href={`mailto:${adv.email}`} className="font-mono text-charcoal-800 dark:text-ivory-100 hover:text-burgundy-800">
                      {adv.email}
                    </a>
                  </div>
                </div>
            ...
            {/* Action Buttons */}
            <div className="pt-6 border-t border-ivory-300 dark:border-stone-800 space-y-3">
